...
const Sobre = () => {
    return (
        ...
        <div className='text-black filter bg-fixed backdrop-blur-sm ' >
            ...
            <p className='text-center md:text-3xl sm:text-3md text-4xl '> A Escola Técnica Estadual Paulistano foi criada em 22 de dezembro de 2009 (DECRETO Nº 55.223) através do Plano Estadual de Expansão do Governo de São Paulo em parceria com o Centro Paula Souza, tendo suas atividades iniciadas em 22 de fevereiro de 2010 atendendo à centenas de alunos distribuídos pelos cursos oferecidos. </p>
            </div>
            </div>
        </div>
        </div>
